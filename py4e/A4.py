...
while endGame!="quit":
    ...
    if (r.status_code !=200):
        endGame=input("Sorry,there is a problem retrieving the question. Press enter to try again or type 'quit' to quit the game.")
    else:
        valid_answer=False
        answer_number=1
        ...
        if(user_answer == correct_answer):
            print("Congratulations! You answered correctly." + html.unescape(correct_answer))
            score_correct+=1
        else:
