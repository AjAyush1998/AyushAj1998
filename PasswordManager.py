...
if(instruct_choice not in choice):
    ...
    if(instruct_choice==1):
        ...
        if gen_pass.upper()=='YES':
            ...
            choiceofpassword=int(input("Enter the serial number of Password:"))
            password=password_list[choiceofpassword-1]
        elif gen_pass.upper()=='NO':
            password=input("Enter your master password (should be atleast 8-14 characters):")
            print (password)
        ...
        if(password==input_master_password):
            ...
            print("1. Enter New Username, Pasword, Website")
            ...
            if(second_choice==1):
                ...
                print("New Username:{}\nNew Password:{}\nWebsite link provided:{}"
                    .format(new_username,new_password,new_website))
                ...
                print("Your details have been matched!\nUsername:\t{}\nPassword:\t{}\nWebsite:\t{}"
                    .format(details[1],details[2],details[3]))
        ...
        if(password==master_password):
            ...
            password_file=open(filename,"w")
            password_file.write("Password:{}".format(new_password))
            cur.execute('''update master_user set password=? where MasterUserName=?''',
                (new_password,master_username))
            database.commit()
            print("Successfully Updated your Password")
        ...
        if(password==master_password):
            print("Password Matched!")
            cur.execute('''Delete from master_user where MasterUserName=? and Pasword=?''',
